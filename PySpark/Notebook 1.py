...
# Tworzę listę [ ], w której jest jeden wiersz ( ), a ten przecinek , gwarantuje, że dobrze zrozumiesz, że to wiersz z jedną kolumną
...
schema = StructType([StructField("raw_html", StringType(), True)])
...
df_cleaned = df.withColumn("clean_text", regexp_replace(col("raw_html"), r'<.*?>', ' '))
